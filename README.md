...
- **[Real Time Chat Application](https://github.com/rohitmanohar2108/Real_Time_Chat_Application)** – Scalable WebSocket-based chat system using Node.js and Redis (pub/sub) for low-latency real-time messaging, deployed on Aiven Cloud.
- **[Real_Time_Device_Tracker](https://github.com/rohitmanohar2108/Real_Time_Device_Tracker)** – Real-time Device tracking system that streams live device locations via WebSockets and visualizes movement on a map, powered by Node.js and Redis for scalable event broadcasting.
